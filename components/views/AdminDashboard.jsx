        ...
        <TabsList className="grid grid-cols-3 w-full max-w-md mb-6 bg-zinc-100 dark:bg-zinc-800 rounded-xl p-1 h-auto">
          {[
            ...
            <TabsTrigger key={t.val} value={t.val}
              className="rounded-lg py-2 text-xs font-semibold data-[state=active]:bg-white dark:data-[state=active]:bg-zinc-900 data-[state=active]:shadow-sm flex items-center gap-1.5">
